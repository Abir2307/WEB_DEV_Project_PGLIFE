...
<body>
    <nav class="navbar navbar-expand-md navbar-light">
        <a class="navbar-brand" href="/PG-Life/index.html">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb py-2">
            <li class="breadcrumb-item">
                <a href="property_list.php">Home</a>
            </li>
            <li class="breadcrumb-item">
...
foreach ($testimonials as $testimonial) {
    // Set the image path based on the gender
    $imageSrc = $testimonial['gender'] === 'female' ? '../img/woman.jpeg' : '../img/man.png';
?>
    <div class="testimonial-block">
        <div class="testimonial-image-container">
            <img class="testimonial-img" src="<?= $imageSrc ?>" alt="Testimonial Image">
        </div>
